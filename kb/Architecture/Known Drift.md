...
(`~/dev/reflective/mosaic-extensions/mnemos`) on 2026-05-05. Foundation no longer ships vector
...
(`~/dev/reflective/mosaic-extensions/prism`) on 2026-05-05. Foundation no longer ships
...
(`~/dev/reflective/mosaic-extensions/arbiter`) on 2026-05-05. Foundation `converge-pack`
...
(`~/dev/reflective/mosaic-extensions/embassy`). LinkedIn is the first example: if the semantic
