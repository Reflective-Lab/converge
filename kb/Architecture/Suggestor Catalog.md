...
(`~/dev/reflective/mosaic-extensions/prism`). Extracted from `converge-analytics` on 2026-05-05.
...
Live in the **prism** extension (`~/dev/reflective/mosaic-extensions/prism`, formerly
...
(`~/dev/reflective/mosaic-extensions/arbiter`). Extracted from `converge-policy` on 2026-05-05.
...
(`~/dev/reflective/mosaic-extensions/mnemos`). Extracted from `converge-knowledge` on 2026-05-05.
