...
//!
//! ```ignore
//! use converge_provider_adapters::brave::{BraveSearchProvider, BraveSearchRequest, BraveCapability};
//!
...
///
/// ```ignore
/// use converge_provider_adapters::brave::{BraveSearchProvider, BraveSearchRequest};
///
/// let provider = BraveSearchProvider::from_env()?;
